function calculateScore() {
    ...
    if (totalScore <= 15) {
        ...
        resultText = `Dina poäng är: ${totalScore}<br><br><strong>Helt okej!</strong> Du är på god väg men det finns mycket att komma ikapp med, hör av dig så hjälper vi dig in i framtiden!<br><br><strong>Andreas Stenhall</strong>, Trusted Advisor inom modern work och security på Coligo. Microsoft MVP på Windows i sedan 16 år. Kontakta mig via <a href="https://teams.microsoft.com/l/chat/0/0?users=andreas.stenhall@coligo.se">Teams</a> eller <a href="mailto:andreas.stenhall@coligo.se">e-post</a>.`;
        ...
        resultText = `Dina poäng är: ${totalScore}<br><br><strong>Fantastiskt!</strong> Du ligger väldigt bra till men det finns säkerligen mer att göra. Hör av dig så tar vi det vidare!<br><br><strong>Andreas Stenhall</strong>, Trusted Advisor inom modern work och security på Coligo. Microsoft MVP på Windows i sedan 16 år. Kontakta mig via <a href="https://teams.microsoft.com/l/chat/0/0?users=andreas.stenhall@coligo.se">Teams</a> eller <a href="mailto:andreas.stenhall@coligo.se">e-post</a>.`;
    }
