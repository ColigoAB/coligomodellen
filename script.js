function calculateScore() {
    ...
    if (totalScore <= 15) {
        ...
        resultText = `<br><strong>Katastrof!</strong> Här finns det mycket att åtgärda, kontakta oss snarast så hjälper vi dig upp på banan och in i framtiden.<br><br><strong>Andreas Stenhall</strong>, Trusted Advisor inom modern work och security på Coligo. Microsoft MVP sedan 16 år. Kontakta mig via <a href="https://teams.microsoft.com/l/chat/0/0?users=andreas.stenhall@coligo.se">Teams</a> eller <a href="mailto:andreas.stenhall@coligo.se">e-post</a>.`;
